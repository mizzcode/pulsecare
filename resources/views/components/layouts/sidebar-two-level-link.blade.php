...
<a href="{{ $href }}" @class([
    ...
    'bg-gray-400 text-sidebar-accent-foreground font-semibold dark:text-white' => $active,
    'hover:bg-gray-400 hover:text-sidebar-accent-foreground hover:font-semibold text-sidebar-foreground dark:text-white' => !$active,
])>
