                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">{{ $user->gender ?? 'Tidak diset' }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                        ...
                                        <p class="mt-4 text-lg">Belum ada user</p>
                                        <p class="text-sm">Mulai dengan menambahkan user pertama</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
